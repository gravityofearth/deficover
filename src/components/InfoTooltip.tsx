...
export const InfoTooltip: React.FC<InfoTooltipProps> = ({ content, link, className = "" }) => {
    ...
    return (
        <div className={`relative inline-block ${className}`}>
            ...
            {isVisible && (
                <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 text-xs text-white bg-black/90 rounded-md opacity-100 transition-opacity duration-200 pointer-events-none z-50 w-[300px]">
